...
# example notebooks called Radial Class Exploration. I used it to ensure that
# my radial object was working correctly. This file is meant to be run with ipython.
# Look at their notebook for more information and comments.

# https://github.com/rucool/hfradarpy/blob/master/examples/notebooks/radial_class_exploration.ipynb


from hfradarpy.radials import Radial

raw_file = 'RDLm_MARA_2024_04_14_2200.ruv'
r0_file = 'RDLm_MARA_2024_04_14_2100.ruv'
radial_file = '../radial-data/raw/MARA/' + raw_file
radial_file

radial_file_qc = '../radial-data/flagged/MARA/' + raw_file
radial_file_qc
...
r0 = '../radial-data/raw//MARA/' + r0_file
